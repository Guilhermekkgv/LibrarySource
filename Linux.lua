...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local ElementContainer1 = Linux.Instance("ScrollingFrame", {
            Parent = TabContent,
            BackgroundColor3 = Color3.fromRGB(19, 19, 19),
            BorderColor3 = Color3.fromRGB(50, 50, 50),
            BorderSizePixel = 2,
        ...
        local ElementContainer2 = Linux.Instance("ScrollingFrame", {
            Parent = TabContent,
            BackgroundColor3 = Color3.fromRGB(19, 19, 19),
            BorderColor3 = Color3.fromRGB(50, 50, 50),
            BorderSizePixel = 2,
            Size = UDim2.new(0, 200, 0, 200),
            Position = UDim2.new(0, 210, 0, 35),
            CanvasSize = UDim2.new(0, 0, 0, 0),
            AutomaticCanvasSize = Enum.AutomaticSize.Y,
            ScrollBarThickness = 2,
            ScrollBarImageColor3 = Color3.fromRGB(0, 120, 255),
        ...
        function TabElements.Button(config)
            local container = config.Container == 2 and ElementContainer2 or ElementContainer1
            local order = config.Container == 2 and elementOrder2 or elementOrder1
